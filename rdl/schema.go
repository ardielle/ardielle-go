...
func (self *BytesTypeDef) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("BytesTypeDef.comment does not contain a valid String (%v)", val.Error)
		}
	}
	return nil
}
...
func (self *StringTypeDef) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("StringTypeDef.comment does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Pattern != "" {
		val := Validate(RdlSchema(), "String", self.Pattern)
		if !val.Valid {
			return fmt.Errorf("StringTypeDef.pattern does not contain a valid String (%v)", val.Error)
		}
	}
	return nil
}
...
func (self *EnumElementDef) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("EnumElementDef.comment does not contain a valid String (%v)", val.Error)
		}
	}
	return nil
}
...
func (self *EnumTypeDef) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("EnumTypeDef.comment does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Elements == nil {
...
func (self *UnionTypeDef) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("UnionTypeDef.comment does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Variants == nil {
...
func (self *ResourceInput) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("ResourceInput.comment does not contain a valid String (%v)", val.Error)
		}
	}
	if self.QueryParam != "" {
		val := Validate(RdlSchema(), "String", self.QueryParam)
		if !val.Valid {
			return fmt.Errorf("ResourceInput.queryParam does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Header != "" {
		val := Validate(RdlSchema(), "String", self.Header)
		if !val.Valid {
			return fmt.Errorf("ResourceInput.header does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Pattern != "" {
		val := Validate(RdlSchema(), "String", self.Pattern)
		if !val.Valid {
			return fmt.Errorf("ResourceInput.pattern does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Context != "" {
		val := Validate(RdlSchema(), "String", self.Context)
		if !val.Valid {
			return fmt.Errorf("ResourceInput.context does not contain a valid String (%v)", val.Error)
		}
	}
	return nil
}
...
func (self *ResourceOutput) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("ResourceOutput.comment does not contain a valid String (%v)", val.Error)
		}
	}
	return nil
}
...
func (self *ResourceAuth) Validate() error {
	if self.Action != "" {
		val := Validate(RdlSchema(), "String", self.Action)
		if !val.Valid {
			return fmt.Errorf("ResourceAuth.action does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Resource != "" {
		val := Validate(RdlSchema(), "String", self.Resource)
		if !val.Valid {
			return fmt.Errorf("ResourceAuth.resource does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Domain != "" {
		val := Validate(RdlSchema(), "String", self.Domain)
		if !val.Valid {
			return fmt.Errorf("ResourceAuth.domain does not contain a valid String (%v)", val.Error)
		}
	}
	return nil
}
...
func (self *Resource) Validate() error {
	...
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("Resource.comment does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Expected == "" {
	...
	if self.Name != "" {
		val := Validate(RdlSchema(), "Identifier", self.Name)
		if !val.Valid {
			return fmt.Errorf("Resource.name does not contain a valid Identifier (%v)", val.Error)
		}
	}
	return nil
}
...
func (self *Schema) Validate() error {
	if self.Namespace != "" {
		val := Validate(RdlSchema(), "NamespacedIdentifier", self.Namespace)
		if !val.Valid {
			return fmt.Errorf("Schema.namespace does not contain a valid NamespacedIdentifier (%v)", val.Error)
		}
	}
	if self.Name != "" {
		val := Validate(RdlSchema(), "Identifier", self.Name)
		if !val.Valid {
			return fmt.Errorf("Schema.name does not contain a valid Identifier (%v)", val.Error)
		}
	}
	if self.Comment != "" {
		val := Validate(RdlSchema(), "String", self.Comment)
		if !val.Valid {
			return fmt.Errorf("Schema.comment does not contain a valid String (%v)", val.Error)
		}
	}
	if self.Base != "" {
		val := Validate(RdlSchema(), "String", self.Base)
		if !val.Valid {
			return fmt.Errorf("Schema.base does not contain a valid String (%v)", val.Error)
		}
	}
	return nil
}
