...
func (pTypeDef *StructTypeDef) Init() *StructTypeDef {
	if pTypeDef.Fields == nil {
		pTypeDef.Fields = make([]*StructFieldDef, 0)
	}
	return pTypeDef
}
...
//
func (pTypeDef *EnumElementDef) UnmarshalJSON(b []byte) error {
	var r rawEnumElementDef
	err := json.Unmarshal(b, &r)
	if err == nil {
		o := EnumElementDef(r)
		*pTypeDef = o
...
// Init - sets up the instance according to its default field values, if any
//
func (pTypeDef *EnumTypeDef) Init() *EnumTypeDef {
	if pTypeDef.Elements == nil {
		pTypeDef.Elements = make([]*EnumElementDef, 0)
	}
	return pTypeDef
}
...
func (pTypeDef *UnionTypeDef) Init() *UnionTypeDef {
	if pTypeDef.Variants == nil {
		pTypeDef.Variants = make([]TypeRef, 0)
	}
	return pTypeDef
}
...
//
func (pTypeDef *ResourceInput) UnmarshalJSON(b []byte) error {
	var r rawResourceInput
	err := json.Unmarshal(b, &r)
	if err == nil {
		o := ResourceInput(r)
		*pTypeDef = o
...
//
func (pTypeDef *ResourceOutput) UnmarshalJSON(b []byte) error {
	var r rawResourceOutput
	err := json.Unmarshal(b, &r)
	if err == nil {
		o := ResourceOutput(r)
		*pTypeDef = o
...
//
func (pTypeDef *ResourceAuth) UnmarshalJSON(b []byte) error {
	var r rawResourceAuth
	err := json.Unmarshal(b, &r)
	if err == nil {
		o := ResourceAuth(r)
		*pTypeDef = o
...
// Validate - checks for missing required fields, etc
//
func (pTypeDef *ResourceAuth) Validate() error {
	return nil
}
...
//
func (pTypeDef *ExceptionDef) UnmarshalJSON(b []byte) error {
	var r rawExceptionDef
	err := json.Unmarshal(b, &r)
	if err == nil {
		o := ExceptionDef(r)
		*pTypeDef = o
...
// Init - sets up the instance according to its default field values, if any
//
func (pTypeDef *Resource) Init() *Resource {
	if pTypeDef.Expected == "" {
		pTypeDef.Expected = "OK"
	}
	return pTypeDef
}
...
//
func (pTypeDef *Resource) UnmarshalJSON(b []byte) error {
	var r rawResource
	err := json.Unmarshal(b, &r)
	if err == nil {
		o := Resource(r)
